...
function Ingredient({ ingredient }) {
  ...
  return (
    <li
      id={_id}
      key={_id}
      className={`${styles.listItem} ${isDrag && styles.dragging}`}
    ...
    >
      ...
      <p
        className={
          "mt-1 mb-1 text text_type_digits-default text_color_primary " +
          styles.paragraph
        }
      >
      ...
      <p
        className={
          "text text_type_main-default text_color_primary " + styles.bunName
        }
      >
        {name}
      </p>
